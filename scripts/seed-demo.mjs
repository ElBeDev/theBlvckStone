...
const products = [
  ...
  },
  {
    ...
    description:
      "100 kWh energy storage system for commercial and light-industrial use. Combines high-density LFP batteries with smart charge/discharge management.",
    specs:
  ...
  },
  {
    ...
    locale: "es",
    category: "energia-limpia",
    title: "AUXSOL Inversor Utility-Scale 350kW",
    description:
  ...
  },
  {
    ...
    locale: "es",
    category: "energia-limpia",
    title: "Panel Solar AUXSOL Mono PERC 550W",
    description:
  ...
  },
  {
    ...
    locale: "en",
    category: "energia-limpia",
    title: "AUXSOL Mono PERC 550W Solar Panel",
    description:
  ...
  // Electromovilidad
  {
    ...
    specs:
      "Autonomía: 320 km (WLTP)\nCapacidad de carga: 1.2 toneladas\nCarga rápida DC: 20-80% en 35 min\nGarantía de batería: 8 años / 200,000 km",
  },
  {
    slug: "bedrock-et5-pickup",
    locale: "en",
  ...
  },
  {
    ...
    specs:
      "Range: 280 km (WLTP)\nCargo volume: 7 m³\nDC fast charging: 20-80% in 40 min\nBattery warranty: 8 years / 160,000 km",
  },
  {
    slug: "estacion-carga-dc-120kw",
    locale: "es",
    category: "electromovilidad",
    title: "Estación de Carga DC 120kW",
    description:
  ...
  },
  {
    ...
    locale: "en",
    category: "electromovilidad",
    title: "120kW DC Charging Station",
    description:
  ...
  },
  {
    ...
    specs:
      "Plazos: 24 a 48 meses\nIncluye mantenimiento preventivo opcional\nAplica a compras de 3+ unidades",
  },
  {
    slug: "arrendamiento-flotas-electricas",
    locale: "en",
    ...
    specs:
      "Terms: 24 to 48 months\nOptional preventive maintenance included\nApplies to purchases of 3+ units",
  },
  {
  ...
  },
  {
    ...
    specs:
      "Amount: up to $5,000,000 MXN\nDraw: on demand\nPreferential rate for clients with an active AUXSOL project",
  },
];
...
Recomendamos migrar 10-15% de la flota primero, medir resultados reales por 3-6 meses, y escalar con datos propios en vez de proyecciones genéricas.
...
An electric truck costs more upfront but less to operate. Fuel and maintenance drop 40-60% versus an internal combustion vehicle, depending on usage.
...
We recommend migrating 10-15% of the fleet first, measuring real results for 3-6 months, and scaling with your own data instead of generic projections.
...
async function main() {
  ...
  for (const t of testimonials) {
    await sql`
      ...
      values (${t.name}, ${t.company}, ${t.role}, ${t.quote})
    `;
  }
